...
void SpinningCubeRenderer::CreateDeviceDependentResources()
{
    ...
    task<void> createCubeTask  = shaderTaskGroup.then([this] ()
    {
...
#endif
			{ XMFLOAT3(-0.526f,  0.296f,  0),  XMFLOAT3(1.0f, 0.0f, 0.0f) }, // vertex 0 non-debug
			{ XMFLOAT3(0.526f,  0.296f,  -0.01f), XMFLOAT3(1.0f, 0.0f, 1.0f) },
			{ XMFLOAT3(0.526f, -0.296f,  -0.01f),  XMFLOAT3(1.0f, 1.0f, 0.0f) },
			{ XMFLOAT3(-0.526f, -0.296f,  0),  XMFLOAT3(1.0f, 1.0f, 1.0f) },
			{ XMFLOAT3(0.527f,  0.296f,  -0.01f), XMFLOAT3(1.0f, 0.0f, 0.0f) },
			{ XMFLOAT3(1.579f,  0.296f,  0), XMFLOAT3(1.0f, 0.0f, 1.0f) },
			{ XMFLOAT3(1.579f, -0.296f,  0), XMFLOAT3(1.0f, 1.0f, 0.0f) },
			{ XMFLOAT3(0.527f, -0.296f,  -0.01f), XMFLOAT3(1.0f, 1.0f, 1.0f) },
        }};
		...
		constexpr std::array<unsigned short, 12>  cubeIndices =
		{
			0,1,2, 0,2,3, //left
...
void SpinningCubeRenderer::SetTexture2D()
{
	//string filename = Windows.ApplicationModel.Package.Current.InstalledLocation.Path;
	Windows::ApplicationModel::Package^ package = Windows::ApplicationModel::Package::Current;
	Windows::Storage::StorageFolder^ installedLocation = package->InstalledLocation;
	//Windows::Storage::StorageFolder^ current = package->;
	
	Platform::String^ output = installedLocation->Path + "\\test.jpg";

	std::string str = pstos(output);
	...
	HRESULT hr = CreateWICTextureFromFile(m_deviceResources->GetD3DDevice(), L"..\\Assets\\test.jpg", m_resource.GetAddressOf(), m_shaderResourceView.GetAddressOf(), 0);
	DX::ThrowIfFailed(hr);

	Microsoft::WRL::ComPtr<ID3D11Texture2D> tex;
	hr = m_resource.As(&tex);
	DX::ThrowIfFailed(hr);
...
void SpinningCubeRenderer::ReleaseDeviceDependentResources()
{
 ...
 std::wstring SpinningCubeRenderer::stows(std::string s)
{
	std::wstring ws;
 ...
 Platform::String^ SpinningCubeRenderer::stops(std::string s)
{
	return ref new Platform::String(stows(s).c_str());
}

 std::string SpinningCubeRenderer::wstos(std::wstring ws)
{
	std::string s;
...
std::string SpinningCubeRenderer::pstos(Platform::String^ ps)
{
